#!/usr/bin/env bash
# Thanks to: https://miloserdov.org/?p=1088 for its modified verison. 04/2021
# Run as: ./hack-captive-portals.sh
# No need for additional dongle or to push the exisint to monitor mode. can run as it is. 
# basically scans the local network for MAC addresses, spoofs each one and tries a ping to 8.8.8.8 to check internet access
# if you see "Pwned! Now you can surf the Internet!", you have successfully spoofed a MAC that has internet acces alreday.
# =========================================================================== #
